package com.ginilab.tomafood.base.retrofit

import android.app.Application
import com.ginilab.tomafood.api.Constants
...
object NetworkBuilder {
    ...
    const val BASE_URL = "https://tomafood.biz/api/v1/"
    ...
    private fun gmHttpClient(application: Application): OkHttpClient {
        ...
        builder.addInterceptor { chain ->
            ...
            //    .addHeader("Request-Type", "Android")
                ...
                .addHeader("apiKey", "abduc384fddbh3mf9dbdl3jdlskeiksurndldsje")
    ...
    private fun provideCache(application: Application): Cache? {
        ...
        try {
            ...
            cache = Cache(file, 20 * 1024 * 1024) //5MB
        } catch (e: Exception) {
        }
        return cache
    }
