...
import com.ginilab.tomafood.ui.main.home.response.Section2Restaurants
...
class Section2ItemDelegate(private val onClick: HomeAdapter.CellListener): AbsListItemAdapterDelegate<Section2Restaurants, Cell, Section2ItemDelegate.Section2ItemHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup): Section2ItemHolder {

        return Section2ItemHolder(
    ...
    override fun isForViewType(item: Cell, items: MutableList<Cell>, position: Int): Boolean {
        return item is Section2Restaurants

    }

    override fun onBindViewHolder(
        item: Section2Restaurants,
        holder: Section2ItemHolder,
        payloads: MutableList<Any>
    ) {
        holder.bind(item)
    }

    class Section2ItemHolder(
        itemView: View,
        ...
        fun bind(listItem: Section2Restaurants){
